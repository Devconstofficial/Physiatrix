...
import 'package:physiatrix/Screens/UserProfiling/decoration3.dart';

class DecorationScreen2 extends StatelessWidget {
  const DecorationScreen2({super.key});
                ...
                child: InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const DecorationScreen3()),
                      );
                    },
